...
const accessNestedProp = <T>(obj: T) => (path: string) => {
...
export function configServicePartialMock<T extends keyof Configuration>(mockPath: T, partialConfigMock: Partial<Configuration[T]>) {
